...
int main(int argc, char const *argv[]){
	...
	while(true){
		//cout << instructions[iteratorPosition].comand << " " << instructions[iteratorPosition].steps << endl;
		if(instructions[iteratorPosition].comand == "acc"){ //acc case	
			globalAcumulator += instructions[iteratorPosition].steps;
			iteratorPosition ++;
		}else if(instructions[iteratorPosition].comand == "jmp"){ //jmp case
			iteratorPosition += instructions[iteratorPosition].steps;
		}else{ //nop case
			iteratorPosition ++;
		}
	...
	cout << "Last index: " << instructions.size() << endl;
